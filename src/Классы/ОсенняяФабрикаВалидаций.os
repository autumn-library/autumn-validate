...
Функция СоздатьОбъектВалидации(Ограничение) Экспорт
	...
	ПрилеплямыеЧастицы = Новый Массив;
	ПрилеплямыеЧастицы.Добавить(Ограничение);

	Валидация = _Поделка.НайтиЖелудь(ИмяЖелудяВалидации, ПрилеплямыеЧастицы);
...
Процедура ПриСозданииОбъекта(
	...
	Для Каждого ДанныеОпределенияЖелудя Из ОпределенияЖелудейВалидаций Цикл
		ОпределениеЖелудя = ДанныеОпределенияЖелудя.Значение;
