...
Процедура ПриЗагрузкеБиблиотеки(Путь, СтандартнаяОбработка, Отказ)
	...
	Если Осень <> Неопределено Тогда
		...
		ПутьДоЗаготовки = ОбъединитьПути(Путь, "src/Заготовки/Инициализация_" + ИмяБиблиотеки + ".os");
		ПодключитьСценарий(ПутьДоЗаготовки, "ИнициализацияСкучныхАннотаций");
		Осень.ДобавитьЗаготовкуДляАвтоИнициализации("ИнициализацияСкучныхАннотаций");
